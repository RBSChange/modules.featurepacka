<?php
class featurepacka_PaymentStatusCustomerFilter extends f_persistentdocument_DocumentFilterImpl
{
	...
	public function getQuery()
	{
		...
		switch ($restriction)
		{
			...
			default: 
				...
				return new featurepacka_IdsContainer(self::getDocumentModel(), array());
		}
	}
	...
	private function getAllForStatus($status)
	{
		...
		return new featurepacka_IdsContainer(self::getDocumentModel(), $ids);
	}
